...
int evenNumbers(int rows, int columns, int value[rows][columns]) {
...
int main() {
    ...
    do {
        ...
        printf("\nHere are the values that are even numbers: \n");
        evenNumbers(rows, columns, value);
